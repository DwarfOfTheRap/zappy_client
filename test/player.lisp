...
(define-test pathing-test
  ...
  (let ((state (set-state)))
    (assert-equal '("gauche") (join-for-incantation 3 nil "test" state 4))
    (assert-equal '("droite") (join-for-incantation 7 nil "test" state 4))
    (assert-equal '("avance" "avance" "gauche" "avance" "avance") (join-for-incantation 2 nil "test" state 1))
